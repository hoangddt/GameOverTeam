...
#define CAMERA_POSITION_UP Vector3(0.5f, 11.0f, -3.0f)
#define CAMERA_ROTATION_UP Vector3(-1.55f, 0.0f, 0.0f)
#define CAMERA_POSITION_FRONT Vector3(0.5f, 8.0f, 3.0f)
#define CAMERA_ROTATION_FRONT Vector3(-0.5f, 0.0f, 0.0f)
