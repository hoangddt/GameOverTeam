...
void init()
{
	Application::getInstance()->init(420, 700);
}
#elif ANDROID
...
extern "C" {
	...
	JNIEXPORT void JNICALL Java_com_gameover_androidport_AndroidPortLib_pause(JNIEnv * env, jobject obj);
};
...
JNIEXPORT void JNICALL Java_com_gameover_androidport_AndroidPortLib_pause(JNIEnv * env, jobject obj)
{
	LOGI("Pause in C is called, Application is pause now\n");
	pause();
}
